...
```{r explorerStartPage, echo=FALSE, fig.cap = "uBiome Explorer Insights Overview"}
knitr::include_graphics(paste0(getwd(),"/assets/ubiomeExplorerStartPageJan24Sample.png"))
...
```{r echo=FALSE}
knitr::include_graphics(paste0(getwd(),"/assets/uBiomeExplorerBacteriaOverviewJan24.png"))
```
...
```{r echo=FALSE}
knitr::include_graphics(paste0(getwd(),"/assets/YourSampleVsAllSamples.png"))
```
